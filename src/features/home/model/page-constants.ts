...
export const i18n = {
  ru: {
    ...
    output: "Результат",
    activity: "Активность",
    activityMessage: "Сообщение",
    activityStatus: "Статус",
    activityTime: "Время",
    activityError: "Ошибка",
    activityStatusSuccess: "Успех",
    activityStatusError: "Ошибка",
    activityStatusWarning: "Предупреждение",
    activityStatusPending: "В ожидании",
    activityStatusInfo: "Инфо",
    pipeline: "Пайплайн",
  ...
  en: {
    ...
    activityStatusWarning: "Warning",
    activityStatusPending: "Pending",
    activityStatusInfo: "Info",
    pipeline: "Pipeline",
    workspace: "Workspace",
